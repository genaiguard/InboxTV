        ...
        <div className="container max-w-6xl mx-auto px-4 md:px-6">
          ...
          <div className="border-t pt-8">
            <p className="text-sm text-muted-foreground mb-4">
              Inbox Transaction Viewer is an independent extension and is not endorsed, certified. Google LLC, Stripe, Inc., or any of their affiliates. "Chrome", "Gmail", and "Stripe" are registered trademarks of their respective owners. Use of these names, trademarks, and brands does not imply endorsement by their respective owners.
            </p>
            <div className="flex flex-col md:flex-row md:justify-between md:items-center">
              <p className="text-xs text-muted-foreground mb-4 md:mb-0">
                We improve our products and advertising by using Microsoft Clarity to see how you use our website. By using our site, you agree that we and Microsoft can collect and use this data. Our <Link href="/privacy" className="underline hover:text-foreground">privacy statement</Link> has more details.
              </p>
